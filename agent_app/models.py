...
class LI_Friends(models.Model):
	linkedin_id1 = models.ForeignKey(LinkedIn_Account)
	linkedin_id2 = models.ForeignKey(LinkedIn_Account)
...
class FB_Friends(models.Model):
	facebook_id1 = models.ForeignKey(Facebook_Account)
	facebook_id2 = models.ForeignKey(Facebook_Account)
